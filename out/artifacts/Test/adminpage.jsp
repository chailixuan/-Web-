                    ...
                    <div class="card-body">
                      <form class="form-horizontal" action="servlet/UpdateSelfsServlet">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="iid" type="text" class="form-control" readonly="readonly" value="<%=info.get(0)%>">
                          </div>
                        </div>
						<div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="ipassword" type="password" class="form-control" readonly="readonly" value="<%=info.get(2)%>">
                          </div>
                        </div>
						 <div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="iname" type="text" class="form-control" onmouseover="this.select()" value="<%=info.get(1)%>">
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="isex" type="text" class="form-control" onmouseover="this.select()" value="<%=info.get(3)%>">
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="iage" type="text" class="form-control" onmouseover="this.select()" value="<%=info.get(4)%>">
                          </div>
                        </div>
						<div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="iphone" type="text" class="form-control" onmouseover="this.select()" value="<%=info.get(5)%>">
                          </div>
                        </div>
						<div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="idepartment" type="text" class="form-control" onmouseover="this.select()" value="<%=info.get(6)%>">
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
          ...
          <div >
            <div >
              <form class="form-horizontal" action="servlet/ChangePasswordServlet">
                ...
                <div>
                  <button type="submit" class="btn btn-primary" onsubmit="return changepassword()">确认修改</button>
